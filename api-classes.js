...
class User {
  constructor(userObj) {
    ...
    this.loginToken = ""; //the token from a signup exists in response.data.token
    this.favorites = []; //all new users are set to empty favorites array
    this.ownStories = []; 
  }
  ...
  static async create(username, password, name) {
    ...
    newUser.loginToken = response.data.token; //ok this is wear we set the token
